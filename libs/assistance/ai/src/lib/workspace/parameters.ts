...
export const generateWorkspaceParameters = z
  .object({
    ...
    configType: z
      .enum(['library', 'module', 'app'])
      .describe(
        'The type of configuration, can be either library, module, or app.',
      ),
    description: z
      .string()
      .describe('The description of the library, module or app.'),
    fields: z
      .array(
        z
          .object({
            ...
            type: z
              .enum(['input', 'select', 'multi', 'checkbox', 'radio', 'file'])
              .describe('The type of the field.'),
            options: z
              .array(z.string())
              .optional()
              .describe('The options for the field, if applicable.'),
            ...
            placeholder: z
              .string()
              .optional()
              .describe('The placeholder for the field, if any.'),
    ...
    children: z
      .any()
      .optional()
      .describe('The children of the configuration, if any.'),
  })
  .required()

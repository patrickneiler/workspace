...
/**
 * Renders a panel background image.
 *
 * @component
 * @param {string} id - The unique identifier for the panel background.
 * @param {React.CSSProperties} style - Additional CSS styles to apply to the SVG element.
 * @param {React.SVGProps<SVGSVGElement>} props - Additional props to apply to the SVG element.
 * @returns {JSX.Element} The rendered panel background image.
 */
...
export const PanelBackground = () => (<Flex
    align="center"
    justify="center"
    position="absolute"
    inset="0"
